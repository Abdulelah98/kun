    ...
    <main data-testid="services-page" className="pt-16">
      ...
      <section className="bg-[#F9FAFB] py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-bold uppercase tracking-widest text-[#f47424] mb-3">الخدمات</p>
          <h1 data-testid="services-title" className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">
            خدماتنا المتكاملة
          </h1>
